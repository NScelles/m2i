...
const avaiblableFilter = document.getElementById("onlyAvailable");
...
registerButton.addEventListener("click", () => {
    let values = document.querySelectorAll(".book");
    libary.addBook(createBook(values[0].value, authors.filter(author => author.name == values[1].value)[0], values[2].value));
    displaylibrary(libary);
});
